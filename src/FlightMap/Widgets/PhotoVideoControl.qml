...
Rectangle {
    ...
    QGCColoredImage {
        ...
        QGCMouseArea {
            ...
            //++
            //onClicked:  mainWindow.showPopupDialogFromSource("qrc:/qml/QGroundControl/GeneralSettings.qml",flyViewSectionLabel);
            //+++
            onClicked:  mainWindow.showFlyViewSettingsTool();
            //onClicked:  _FlyViewSettings.sayHello();
        }
    }
